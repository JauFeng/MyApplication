...
import com.turing.sean.myapplication.MainActivity;
 ...
 * in a {@link ChooseSectionActivity}.
 */
...
//        });
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(DoctorDetailFragment.ARG_DOCTOR_ID, getIntent().getStringExtra(DoctorDetailFragment.ARG_DOCTOR_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, ChooseSectionActivity.class));
            return true;
        }
