...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "15001109204:crow1984", "15001109200:crow1984"
    };
    /**
    ...
    // UI references.
    private AppCompatEditText mMobileView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMobileView = (AppCompatEditText) findViewById(R.id.mobile);
//        populateAutoComplete();
        ...
        AppCompatButton mMobileSignInButton = (AppCompatButton) findViewById(R.id.mobile_sign_in_button);
...
//                finish();
    ...
    public void goForwardMainActivity() {
